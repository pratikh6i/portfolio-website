                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    >
                        ...
                        <p className="text-xs text-[var(--text-tertiary)]">
                            © {currentYear} Pratik Shetti. Built with ❤️ using Antigravity
                        </p>
                    </motion.div>
                </div>

                {/* Bottom - Vibe Coder Badge */}
                <motion.div
                    ...
                    viewport={{ once: true }}
                >
                    <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-purple-100 to-pink-100 text-purple-600 text-sm font-medium">
                        <span>⚡</span>
                        Vibe Coder Mode: ON
                    </span>
                </motion.div>
